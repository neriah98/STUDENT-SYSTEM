...
class LecturerInfo(models.Model):
    ...
    #lecturer_img = models.ImageField(upload_to='photos/%Y/%m/%d/')
    #passing_year = models.CharField(max_length=100)
    joining_date = models.DateField(auto_now_add=True)
    dept_type = models.ForeignKey(LecturerDeptInfo, on_delete=models.CASCADE ,null=True)
    sub_type = models.ForeignKey(LecturerSubInfo, on_delete=models.CASCADE,null=True)
